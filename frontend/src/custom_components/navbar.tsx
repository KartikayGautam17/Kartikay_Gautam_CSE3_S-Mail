...
import { SearchBar } from "@/custom_components/search-bar";
        ...
        <div className="ml-4">
          ...
          >
            ...
            <g id="vbkDmc">
              <path
                fill="#ea4335"
                d="M25.17 6.71c-3.28 0-5.954 2.505-5.954 5.958 0 3.433 2.673 5.96 5.954 5.96 3.282 0 5.955-2.527 5.955-5.96 0-3.453-2.673-5.96-5.955-5.96zm0 9.567c-1.8 0-3.35-1.487-3.35-3.61 0-2.14 1.55-3.608 3.35-3.608s3.35 1.46 3.35 3.61c0 2.12-1.55 3.61-3.35 3.61z"
              ></path>
            </g>
            <g id="idEJde">
              <path
